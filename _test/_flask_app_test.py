...
bot.setWebhook("https://webpage_url/{}".format(secret), max_connections=1)
...
def telegram_webhook():
    ...
    if "message" in update:
        ...
        if text == "/start":
            bot.sendMessage(chat_id, "Hello, I'm your Therapist. How can I help you?")
        elif text == "/stop":
            bot.sendMessage(chat_id, "Ok, it was pleasure to meet you. I hope see you soon, Bye~")
        else:
